...
namespace reflective
{
	namespace
	{
		...
		public:
			...
			using List = DenseList < TestObjectBase, std::allocator<TestObjectBase>, ElementType<TestObjectBase, ElementTypeCaps::nothrow_move_construtible, SizeAlignmentMode::compact> >;
