...
namespace reflective
{
	namespace
	{
		...
		public:
			...
			using List = DenseList < TestObjectBase, std::allocator<TestObjectBase>, RuntimeType<TestObjectBase, ElementTypeCaps::nothrow_move_construtible, SizeAlignmentMode::compact> >;
