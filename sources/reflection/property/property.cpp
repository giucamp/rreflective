...
{
	bool Property::get_value_by_copy(ObjPtr i_owner_object, void * i_dest, OutBufferTextStream & o_fail_reason) const
	{
		return get_value_by_copy_impl(i_owner_object, i_dest, o_fail_reason);
	}

	bool Property::get_value_by_move(ObjPtr i_owner_object, void * i_dest, OutBufferTextStream & o_fail_reason) const
	{
		return get_value_by_move_impl(i_owner_object, i_dest, o_fail_reason);
	}

	bool Property::set_value_by_copy(ObjPtr i_owner_object, const void * i_source, OutBufferTextStream & o_fail_reason) const
	{
		return set_value_by_copy_impl(i_owner_object, i_source, o_fail_reason);
	}

	bool Property::set_value_by_move(ObjPtr i_owner_object, void * i_source, OutBufferTextStream & o_fail_reason) const
	{
