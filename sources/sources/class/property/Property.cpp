...
namespace reflective
{
	...
	bool Property::set_value(const void * i_owner_object, const void * i_source, TextOutStream * i_error_stream) const
	{
		return set_value_impl(i_owner_object, i_source, i_error_stream);
	}

	const void * Property::get_value_inplace(const void * i_owner_object, TextOutStream * i_error_stream) const
	{
		return get_value_inplace_impl(const_cast<void*>(i_owner_object), i_error_stream);
	}

	void * Property::get_editable_value_inplace(void * i_owner_object, TextOutStream * i_error_stream) const
	{
